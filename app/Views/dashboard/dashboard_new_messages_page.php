                    ...
                    <ul data-submenu-title="">
                        ...
                        <li class="active"><a><i class="sl sl-icon-envelope-open"></i> Messages<span class="nav-tag messages"><?php echo $nbNewMessages ?></span></a>
                            <ul>
                                ...
                                <li class="active"><a href="<?php echo base_url() . "/pro/messages/new" ?>">Nouveaux<span class="nav-tag green"> <?php echo $nbNewMessages ?></span></a></li>
                                        ...
                                        <div class="list-box-listing bookings">
                                            ...
                                            <div class="list-box-listing-content">
                                                <div class="inner">
                                                    ...
                                                    <a href="#" class="rate-review approve" onmouseover="$(this).nextAll('div').first().toggle();" onmouseout="$(this).nextAll('div').first().toggle();"><i class="sl sl-icon-check"></i>Prendre en compte</a>
                                                    ...
                                                    <a href="<?php if (isset($_GET["filter"]) && $_GET["filter"] === "satisfied") {
                                                                    echo base_url() . '/pro/messages/new/update/' . $message["id"] . '?status=to-treat&filter=satisfied ';
                                                                } elseif (isset($_GET["filter"]) && $_GET["filter"] === "unsatisfied") {
                                                                    echo base_url() . '/pro/messages/new/update/' . $message["id"] . '?status=to-treat&filter=unsatisfied ';
                                                                } else {
                                                                    echo base_url() . '/pro/messages/new/update/' . $message["id"] . '?status=to-treat ';
                                                                }
                                                    ...
                                                    <a href="<?php if (isset($_GET["filter"]) && $_GET["filter"] === "satisfied") {
                                                                    echo base_url() . '/pro/messages/new/update/' . $message["id"] . '?status=archived&filter=satisfied ';
                                                                } elseif (isset($_GET["filter"]) && $_GET["filter"] === "unsatisfied") {
                                                                    echo base_url() . '/pro/messages/new/update/' . $message["id"] . '?status=archived&filter=unsatisfied ';
                                                                } else {
                                                                    echo base_url() . '/pro/messages/new/update/' . $message["id"] . '?status=archived';
                                                                }
