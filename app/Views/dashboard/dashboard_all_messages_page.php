                    ...
                    <ul data-submenu-title="">
                        ...
                        <li class="active"><a><i class="sl sl-icon-envelope-open"></i> Messages<span class="nav-tag messages"><?php echo $nbNewMessages ?></span></a>
                            <ul>
                                ...
                                <li class="active"><a href="<?php echo base_url() . "/pro/messages/all" ?>">Tous <span class="nav-tag" ;><?php echo $nbAllMessages ?></span></a></li>
                                    ...
                                    <div class="sort-by-select">
                                        <select data-placeholder="Default order" class="chosen-select-no-single" id="my_selection">
                                            ...
                                            if (isset($_GET["filter"]) && $_GET["filter"] === "satisfied") {
                                                echo " <option value='all' href='" . base_url() . '/pro/messages/all' . "'>Tout</option>
                                                <option value='satisfied' href='" . base_url() . '/pro/messages/all?filter=satisfied' . "' selected >Satifaits</option>
                                                <option value='unsatisfied' href='" . base_url() . '/pro/messages/all?filter=unsatisfied' . "'>Insatifaits</option>";
                                            } elseif (isset($_GET["filter"]) && $_GET["filter"] === "unsatisfied") {
                                                echo " <option value='all' href='" . base_url() . '/pro/messages/all' . "'>Tout</option>
                                                <option value='satisfied' href='" . base_url() . '/pro/messages/all?filter=satisfied' . "'>Satifaits</option>
                                                <option value='unsatisfied' href='" . base_url() . '/pro/messages/all?filter=unsatisfied' . "' selected >Insatifaits</option>";
                                            } else {
                                                echo " <option value='all' href='" . base_url() . '/pro/messages/all' . "' selected >Tout</option>
                                                <option value='satisfied' href='" . base_url() . '/pro/messages/all?filter=satisfied' . "'>Satifaits</option>
                                                <option value='unsatisfied' href='" . base_url() . '/pro/messages/all?filter=unsatisfied' . "'>Insatifaits</option>";
                                            }
                                            ?>
                                            ...
                                            <div class="list-box-listing-content">
                                                <div class="inner">
                                                    ...
                                                    <a href="<?php if (isset($_GET["filter"]) && $_GET["filter"] === "satisfied") {
                                                                    echo base_url() . '/pro/messages/all/update/' . $message["id"] . '?status=to-treat&filter=satisfied ';
                                                                } elseif (isset($_GET["filter"]) && $_GET["filter"] === "unsatisfied") {
                                                                    echo base_url() . '/pro/messages/all/update/' . $message["id"] . '?status=to-treat&filter=unsatisfied ';
                                                                } else {
                                                                    echo base_url() . '/pro/messages/all/update/' . $message["id"] . '?status=to-treat ';
                                                                }
                                                    ...
                                                    <a href="<?php if (isset($_GET["filter"]) && $_GET["filter"] === "satisfied") {
                                                                    echo base_url() . '/pro/messages/all/update/' . $message["id"] . '?status=archived&filter=satisfied ';
                                                                } elseif (isset($_GET["filter"]) && $_GET["filter"] === "unsatisfied") {
                                                                    echo base_url() . '/pro/messages/all/update/' . $message["id"] . '?status=archived&filter=unsatisfied ';
                                                                } else {
                                                                    echo base_url() . '/pro/messages/all/update/' . $message["id"] . '?status=archived';
                                                                }
