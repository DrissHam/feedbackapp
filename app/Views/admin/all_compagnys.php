                ...
                <table class="basic-table">
                    <?php if (session()->getFlashdata('admin')) { ?>
                        <div class="notification success closeable">
                            <p> <?= session()->getFlashdata('admin') ?></p>
                            <a class="close"></a>
                        </div>
                    <?php  } ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>Contacter</th>
                            <th>Supprimer</th>
                            <th>Messagerie du partenaire</th>
                        </tr>
                        <?php foreach ($compagnys as $compagny) : ?>
                            <tr>
                                ...
                                <td data-label="Column 3"> <a href="<?php echo base_url() . "/search/" . $compagny["id"] ?>">Lien vers rédaction message</a> </td>
                                <td data-label="Column 4"> <a href="<?php echo base_url() . "/admin/delete/" . $compagny["id"] ?>">Delete Compagny</a> </td>
                                <td data-label="Column 5"> <a href="<?php echo base_url() . "/admin/list_all_messages/" . $compagny["id"] ?>">Acces Messagerie</a> </td>
