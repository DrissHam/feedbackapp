...
32<link id="color" rel="stylesheet" href="<?php echo base_url() . "/css/main-color.css"; ?>">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>Listings</h2><span>Liste des compagnies partenaires:</span>
		...
		<div class="col-md-12">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12">
					<div class="listing-item-container list-layout" style="height: 26.5%;" >
                    <a href="<?php echo base_url() . "/admin/list_all_messages/" . $compagny["id"] ?>" class="listing-item">
                            ...
                            <img src=" <?php echo base_url() . "/pages/images/avatar_img" . $compagny['id']; ?>" alt="">
								<span class="tag">Restauration</span>
							</div>
							
							<!-- Content -->
							<div class="listing-item-content">
								<div class="listing-badge now-open">Acces Messagerie</div>

								<div class="listing-item-inner">
									<h3><?= esc($compagny['compagny_name']) ?><i class="verified-icon"></i></h3>
									<span><?= esc($compagny['address']) ?>964 School Street, New York</span>
					...
					<div class="listing-item-container list-layout">
						<a href="listings-single-page.html" class="listing-item">
							...
							<div class="listing-item-image">
                                ...
                                <img src=" <?php echo base_url() . "/images/listing-item-01.jpg"; ?>" alt="">
...
<script src=" <?php echo base_url() . "/https://maps.googleapis.com/maps/api/js?libraries=places&callback=initAutocomplete"; ?>"></script>
