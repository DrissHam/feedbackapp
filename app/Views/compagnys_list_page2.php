            ...
            <div class="dashboard-nav">
                <div class="dashboard-nav-inner">
                    ...
                    <ul data-submenu-title="">
                        <li><a href="dashboard.html"><i class="sl sl-icon-action-undo"></i> Effectuer une nouvelle recherche</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="dashboard-list-box margin-top-0">
                            <h4>Voici la liste de nos partenaires qui corréspondent à votre recherche :</h4>
                            <ul>
                                <?php  foreach($compagnys as $compagny) : ?>
                                <li>
                                    <div class="list-box-listing">
                                        <div class="list-box-listing-img"><a href="#"><img
                                                    src="images/listing-item-01.jpg" alt=""></a></div>
                                        <div class="list-box-listing-content">
                                            <div class="inner">
                                                <h3><a href="<?php echo base_url() . "/search/". $compagny["id"] ?>"><?= esc($compagny['compagny_name']) ?></a></h3>
                                                <span><?= esc($compagny['address']) ?></span>
                                    ...
                                    <div class="buttons-to-right">
                                        <a href="<?php echo base_url() . "/search/". $compagny["id"] ?>" class="button gray"><i class="sl sl-icon-note"></i> Je laisse mon avis</a>
                                ...
                                <li>
                                    <div class="list-box-listing">
                                        <div class="list-box-listing-img"><a href="#"><img
                                                    src="images/listing-item-03.jpg" alt=""></a></div>
                                        <div class="list-box-listing-content">
                                            <div class="inner">
